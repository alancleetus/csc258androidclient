...
public class MLASharePostFragment extends Fragment {
    View view;
    ...
    String msg, originalId;

    HashMap<String, String> groupMap = new HashMap<String, String>();
    // extract the extras that was sent from the previous intent
    void getExtra() {
        Intent previous = MLASharePostFragment.this.getActivity().getIntent();
    ...
    @SuppressLint("ValidFragment")
    public MLASharePostFragment(String msg, String originalId) {
        this.msg = msg;
        this.originalId = originalId;

        System.out.println("MLALog: getextra in mlashareposts fragment msg= "+msg+" original id="+originalId);
    }
